...
@RestController
@RequestMapping("/api/files") // API chung để lấy file
public class FileController {
    ...
    @GetMapping("/dausach/{filename:.+}")
    public ResponseEntity<Resource> getBookImage(@PathVariable String filename) {
        try {
            Path fileStorageLocation = Paths.get(uploadDir).resolve("images/dausach").normalize();
